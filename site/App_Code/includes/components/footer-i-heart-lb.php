<section aria-labelledby="footer-i-heart-lb-heading" class="mt-5 mb-5">
    ...
    <h3 class="h5 mb-3">Dark Option</h3>
    <div class="bg-surface-subtle rounded p-4 p-lg-5 mb-5">
        <?php component_footer_i_heart_lb([], 'dark'); ?>
    </div>

    <h3 class="h5 mb-3">Full Width Option</h3>
    <div class="bg-surface-subtle rounded p-4 p-lg-5 mb-5">
        ...
        <table class="table align-middle">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>string</td>
                    <td>light</td>
                    <td>Supported values are <code>light</code> and <code>dark</code>. The dark option uses the alternate <code>i-dark.svg</code> and <code>lb-dark.svg</code> artwork.</td>
                </tr>
                <tr>
                    <td>Fill Width</td>
                    <td>boolean</td>
                    <td>false</td>
                    <td>When set to <code>true</code>, the lockup expands to fill the width of its container while preserving the proportions of the I, heart, and LB artwork.</td>
                </tr>
                <tr>
                    <td>Autoplay</td>
                    <td>behavior</td>
