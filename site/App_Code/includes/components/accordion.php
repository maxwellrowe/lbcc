<section aria-labelledby="accordion-component-heading" class="mt-5 mb-5">
    <h2 id="accordion-component-heading">Accordion</h2>
    ...
    <div class="mb-5 d-grid gap-5">
        ...
        <div>
            ...
            component_accordion(
                ...
                'component-accordion-surface-raised',
                true,
                true,
                'surface-raised'
            );
